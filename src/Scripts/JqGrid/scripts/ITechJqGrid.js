...
function initPagedJqgrid(gridId, gridNavId, columnNames, columnModel, dataUrl, editUrl,
    ...
    jQuery(gridId).jqGrid({
        ...
        ajaxSelectOptions: { type: "POST", dataType: "json", cache: false }
    });
    if (!showTitle) {
        $(".ui-jqgrid-titlebar").hide();
    }
...
}).jqGrid('navGrid', gridNavId, { search: false, add: add, edit: edit, del: del }, editSettings, addSettings, delSettings,
  {

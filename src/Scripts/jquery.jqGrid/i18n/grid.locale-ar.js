...
$.extend($.jgrid,{
	defaults : {
		recordtext: "عنصر {0} - {1} على {2}",
		emptyrecords: "لا يوجد عنصر",
		loadtext: "تحميل...",
		pgtext : "صفحة {0} على {1}"
	},
	search : {
		...
		Find: "بحث",
		Reset: "إلغاء",
		odata: [{ oper:'eq', text:"يساوي"},{ oper:'ne', text:"يختلف"},{ oper:'lt', text:"أقل"},{ oper:'le', text:"أقل أو يساوي"},{ oper:'gt', text:"أكبر"},{ oper:'ge', text:"أكبر أو يساوي"},{ oper:'bw', text:"يبدأ بـ"},{ oper:'bn', text:"لا يبدأ بـ"},{ oper:'in', text:"يحتوي على"},{ oper:'ni', text:"لا يحتوي على"},{ oper:'ew', text:"ينته بـ"},{ oper:'en', text:"لا ينته بـ"},{ oper:'cn', text:"يحتوي"},{ oper:'nc', text:"لا يحتوي"}],
	...
	edit : {
		...
		bCancel: "إلغاء",
		bClose: "غلق",
		saveData: "تغيرت المعطيات هل تريد العنصر ?",
		bYes: "نعم",
		bNo: "لا",
		bExit: "إلغاء",
		msg: {
	...
	view : {
		caption: "رأيت العنصرات",
		bClose: "غلق"
	},
	del : {
		caption: "حذف",
		msg: "حذف العنصرات المختارة ?",
		bSubmit: "حذف",
		bCancel: "إلغاء"
	},
	nav : {
		edittext: " ",
		edittitle: "تغيير العنصر المختار",
		addtext:" ",
		addtitle: "إضافة عنصر",
		deltext: " ",
		deltitle: "حذف العنصر المختار",
		searchtext: " ",
		searchtitle: "بحث عن عنصر",
		refreshtext: "",
	...
	errors : {
		...
		norecords: "لا يوجد عنصر للمعالجة",
		model : "عدد العناوين (colNames) <> عدد العنصرات (colModel)!"
	},
	formatter : {
